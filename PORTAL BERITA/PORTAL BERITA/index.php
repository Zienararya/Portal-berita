...
<body>
    <nav class="navbar navbar-dark bg-primary shadow fixed-top">
            <span class="navbar-brand mb-0 h1 ms-4">Portal Berita Surabaya</span>
        </div>
    </nav>
<div class="container">
    <br>
    <h4 class="mt-5"><center>BERITA HARI INI</center></h4>
<?php
...
<a href="create.php" class="btn btn-primary" role="button">Tambah Berita</a>
    ...
    <footer class="bg-primary text-white text-center pb-3">
      <p>Created by<a href="https://instagram.com/_whoiszienararya" class="text-white fw-bold">Kenzie Nararya</a></p>
    </footer>
